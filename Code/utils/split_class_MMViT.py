...
def split_class(pred_path, img_name, w_gt, h_gt):
    ...
    cls_save_1 = pred_path.replace('class_12', 'Ground-glass opacities/MulCls_MobileViTSeg')
    cls_save_2 = pred_path.replace('class_12', 'Consolidation/MulCls_MobileViTSeg')
