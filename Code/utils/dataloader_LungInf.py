...
class COVIDDataset(data.Dataset):
    def __init__(self, image_root, gt_root, edge_root, trainsize):
        ...
        self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.jpg') or f.endswith('.png') or f.endswith('.bmp') or f.endswith('tif')]
        ...
        if len(edge_root) != 0:
            ...
            self.edges = [edge_root + f for f in os.listdir(edge_root) if f.endswith('.jpg') or f.endswith('.png') or f.endswith('.bmp') or f.endswith('tif')]
